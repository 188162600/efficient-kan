    ...
    def initialize_grid_from_parent(self, parent, x):
        ...
        for i in range(20):
            def closure():
                ...
                return loss
            opt.step(closure)
    def plot(self,x, file_name="figures.pdf", beta=3,scale=0.5, tick=False, sample=False, in_vars=None, out_vars=None, title=None):
        '''
        plot KAN
...
class RBFKANLayerBias(nn.Module):
    def __init__(self, in_features,out_features,num_basis,base_fn=...,basis_trainable=False,ranges=None,kernel=...,dtype=None,device=None):
